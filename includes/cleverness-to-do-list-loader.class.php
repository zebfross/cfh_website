...
class CTDL_Loader {
	...
	public static function add_admin_js() {
		...
		wp_register_script( 'cleverness_tablesorter_widgets_js', CTDL_PLUGIN_URL.'/js/jquery.tablesorter.widgets.js', '', CTDL_PLUGIN_VERSION, true );
		...
		wp_enqueue_script( 'cleverness_tablesorter_widgets_js' );
